# Generated by Django 3.2.13 on 2022-09-20 16:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='post_category', to='blog.category')),
            ],
            options={
                'ordering': ['-created_on'],
            },
